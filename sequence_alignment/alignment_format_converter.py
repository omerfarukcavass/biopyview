...
class ConvertAlignmentFormat(ModalWindow):
    def __init__(self, parent):
        self.parent = parent
        super().__init__(self.parent, resizable=False)
        self.title("Alignment File Format Converter")
        ...
        self.in_supported_formats = list(AlignIO._FormatToIterator.keys())
        self.out_supported_formats = list(AlignIO._FormatToWriter.keys())
