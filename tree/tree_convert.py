...
class ConvertTree(ModalWindow):
    def __init__(self, parent):
        self.parent = parent
        super().__init__(self.parent, resizable=False)
        self.title("Phylogenetic Tree Converter")
        self.is_closed_succesfully = False

        self.supported_formats = ["newick", "nexus", "phyloxml", "nexml"]
        ...
        tk.Button(self, text="Convert", command=self.convert_tree).grid(row=4, column=1, padx=5, pady=20)
